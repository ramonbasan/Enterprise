...
public class Carro implements Serializable{
	...
	@Id
	@Column(name="CD_CARRO") // Trocar o nome da Coluna do Banco de Dados 
	@GeneratedValue(generator="carro", strategy=GenerationType.SEQUENCE) // Gera o Id automatico para a tabela
	private int id;
	...
	@Lob //gravar arquivos no banco de dados (BLOB)
	@Column(name="FL_FOTO")
	private byte[] foto;
	
	@Enumerated(EnumType.STRING)// vai gravar no banco o nome do enum, por padrão ele grava a posição do enum
